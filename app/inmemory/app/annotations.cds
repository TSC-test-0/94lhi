...
annotate guitarStoreSrv.Discount with @UI.HeaderInfo: { TypeName: 'Discount', TypeNamePlural: 'Discounts', Title: { Value: discountAmount } };
annotate guitarStoreSrv.Discount with {
  ID @Common.Text: { $value: discountAmount, ![@UI.TextArrangement]: #TextOnly }
};
annotate guitarStoreSrv.Discount with @UI.Identification: [{ Value: discountAmount }];
annotate guitarStoreSrv.Discount with {
